...
from Demoapp.serializers import NikeSerializer, RegisterSerializer, LoginSerializer, LogoutSerializer
from Demoapp.factories import NikeFactory, UserFactory
...
class NikeListTestCase(TestCase):
    ...
    def test_post_nike(self):
        ...
        image_path = "/home/naitik/Projects/Django-reactapp/BackendReact/Demoapp/test_image.jpg"
